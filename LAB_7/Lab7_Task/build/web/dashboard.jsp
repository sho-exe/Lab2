        ...
        <div class="container d-flex justify-content-center align-items-center"
            ...
            <div class="card shadow-lg border-0 rounded-4 p-4 p-md-5 text-center"
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted fs-5 mb-4">Matric Number: <strong class="text-secondary"><%= user.getMatricNo()%> </strong>
                    <div class="d-flex justify-content-center gap-3 flex-wrap">
                        <a href="viewSubjects.jsp" class="btn btn-primary px-4 py-2
                           fw-semibold">Register Subjects</a>
